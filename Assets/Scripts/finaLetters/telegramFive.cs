...
public class telegramFive : MonoBehaviour
{
    ...
    void UpdateText()
    {
        text1.text = gibMan.gibberishText[92];
        text2.text = gibMan.gibberishText[93];
        text3.text = gibMan.gibberishText[94];
        text4.text = gibMan.gibberishText[95];
        text5.text = gibMan.gibberishText[96];
        text6.text = gibMan.gibberishText[97];
        text7.text = gibMan.gibberishText[98];
        text8.text = gibMan.gibberishText[99];
        text9.text = gibMan.gibberishText[100];
