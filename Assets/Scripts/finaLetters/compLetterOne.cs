...
public class compLetterOne : MonoBehaviour
{
    ...
    void UpdateText()
    {
        text1.text = gibMan.gibberishText[17];
        text2.text = gibMan.gibberishText[18];
        text3.text = gibMan.gibberishText[19];
        text4.text = gibMan.gibberishText[20];
        text5.text = gibMan.gibberishText[21];
        text6.text = gibMan.gibberishText[22];
        text7.text = gibMan.gibberishText[23];
        text8.text = gibMan.gibberishText[24];
    }
